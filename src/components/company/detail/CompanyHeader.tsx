            ...
            <div className='flex shrink-0 flex-col gap-3 sm:flex-row'>
              ...
              {company.company_website_url && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='inline-flex w-[120px] items-center justify-center gap-2 whitespace-nowrap rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 hover:border-violet-200 hover:bg-violet-50 hover:text-violet-700'
                >
