...
export function LoginForm({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  // ========== USE AUTH HOOK ==========
  const { login, isShowPassword, toggleShowPassword, isLoading, error, redirectByRole, handleGoogleLogin } = useAuth()
            ...
            <FieldGroup>
              ...
              {(error || urlError) && (
                <Alert variant='destructive'>
                  <AlertDescription>
                    {error || (urlError === 'google_auth_failed' ? 'Đăng nhập Google thất bại' : 'Có lỗi xảy ra')}
                  </AlertDescription>
                </Alert>
              )}
